...
namespace superKnights
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "superKnights", Version = "v1" });
      });
      ...
      services.AddTransient<KnightQuestService>();
      services.AddTransient<KnightQuestRepository>();
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      if (env.IsDevelopment())
      {
        ...
        app.UseSwagger();
        app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "superKnights v1"));
